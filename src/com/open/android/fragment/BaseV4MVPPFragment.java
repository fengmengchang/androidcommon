 ...
 ***************************************************************************************************************************************************************************** 
 */
public class BaseV4MVPPFragment<T,F extends BaseV4MVPPFragment,P extends CommonPresenter> extends Fragment  implements CommonView<T,P>{
	public static final String TAG = BaseV4MVPPFragment.class.getSimpleName();
	public static final String KEY_CONTENT = BaseV4MVPPFragment.class.getSimpleName() + ":Content";
	public String mContent = "";
	public WeakReferenceMVPPHandler weakReferenceHandler;
	public View view;
	public String url;
	...
	public void setFragment(F f) {
		 weakReferenceHandler = new WeakReferenceMVPPHandler(f);
	}
